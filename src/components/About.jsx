      ...
      <div className="about-w3layouts" id="about">
        <div className="container">
          ...
          <div className="col-md-8 about-right">
            <div className="about-border-w3ls"></div>
            <div className="person-info-agileits-w3layouts">
              <p className="para-agileits-w3layouts">
                <span>Hi! </span>
                I've always been drawn to the overlap between design and
                development. My skills are broad: from ux to design, front end
                to back end development. I enjoy each aspect, and love building
                sites from start to finish, for clients all over the world. I
                work primarily with Node.js and flask on the back-end and
                ReactJs on the front-end but picking up new frameworks isn’t a
                problem.
              </p>
              <ul>
                <li>
              ...
              <div className="pos-w3ls">
                <h4>
                  <span className="red-w3ls">Get</span> in touch
                </h4>
                <div className="button-w3layouts">
